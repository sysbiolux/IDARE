 ...
 *  Code provided by Rob Camick on November 28, 2010 on his webblog. 
 *  http://tips4java.wordpress.com/2010/11/28/combo-box-popup/
 */
...
public class BoundsPopupMenuListener implements PopupMenuListener
{
	...
	protected void customizePopup(BasicComboPopup popup)
	{
		...
		if(comboBox.isShowing())
		{
			...
			{
				//Small Bugfix here: get the actual height of this combobox not its preferred height!

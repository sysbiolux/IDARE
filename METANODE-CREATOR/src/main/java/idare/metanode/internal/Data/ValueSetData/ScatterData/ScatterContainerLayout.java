	 ...
	 */
	 ...
	 public void createLayout(NodeData data, Rectangle area, String DataSetLabel) {
		 ...
		 {		
			 ...
			 PrintFDebugger.Debugging(this, "There are a total of " + headers.size() + " headers");
	 ...
	 private void calcNormalLayoutpositions(Rectangle area)
	 {
		 ...
		 PrintFDebugger.Debugging(this, "Generating Node Axes with following path: " + (area.getX()+1) + "/" +ydrawMin + "\t" + (area.getX()+1) +"/" +(area.getHeight()-1) + "\t" + xdrawMax +"/" + (area.getHeight()-1));

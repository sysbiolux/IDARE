...
public class SBMLManagerHolder {
	...
	public void setObject(Object o)
	{
		if(o == null)
		{
			//PrintFDebugger.Debugging(this," Setting the Manager to null" );	
		}
		else
		{
			//PrintFDebugger.Debugging(this," Setting the Manager to an SBMLManager object" );
		}
	...
	{		
		...
		if(SBMLMgr != null)
		{
			...
			try{
				...
				if( o != null)
				{
					//PrintFDebugger.Debugging(this,"Setting new SBML Document to cy3sbml document" );

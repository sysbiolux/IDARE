package idare.metanode.Interfaces.DataSets;
...
import idare.metanode.internal.DataSetReaders.CSVReader.CSVWorkbook;
...
//		TranslationToObject = new HashMap<>();
	 ...
	 */
	protected void readDataFile(IDAREWorkbook WB) throws IOException,WrongFormat,DuplicateIDException
	{
		//IDAREWorkbook WB = null;
		//try
		//{

...
public abstract class AbstractArrayContainerLayout extends ContainerLayout {
	 ...
	 * @param data the {@link ArrayNodeData} to use for layout generation
...
//		PrintFDebugger.Debugging(this, "Creating Legend Layout position");
	 ...
	 */
	private void LayoutDataForImageNode(ArrayNodeData ndata, SVGGraphics2D context, ColorMap colors)
	{
		int itemid = 1;
	 ...
	 * @param colors the Colormap to use.
	 */
	private void LayoutDataForLegendNode(ArrayNodeData ndata, SVGGraphics2D context, ColorMap colors)
	{
		int itemid = 1;

...
SessionLoadedListener, GraphicsChangedListener {
	...
	public StyleManager(ImageStorage imf, VisualMappingManager vmmServiceRef, CyNetworkViewManager cyNetViewMgr,
			CyEventHelper eventHelper, NodeManager nm, CyApplicationManager cyAppMgr, ActiveNodeManager anm, VisualProperty nodeLabelProperty)
	{		
		this.imf = imf;
		this.anm = anm;
	...
	private void setMappings(VisualStyle currentstyle)
	{
		...
		currentstyle.addVisualMappingFunction(nodeLabelPosition);		

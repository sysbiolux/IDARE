...
//				 PrintFDebugger.Debugging(this, "Data is not null");
				 ...
				 {
					 Vector<Comparable> lineHeaders = ((MultiArrayDataSet)data.getDataSet()).getHeadersForSheet(name);
	 ...
	 /**
 	  ...
 	  * The X and y values have to have the same length.
	  * @param SheetName The name of the sheet currently plotted
	  * @param xvalues the xvalues to use for the plot
	  * @param yvalues the y-values used for the plot 
	  * @param area the area to plot in (x/y are the offsets used for plotting, width and height the area at the offset point)
	  * @param g2d the graphics context to plot in.
	  */
	  ...
	  * @return a path with a marker type depending on the itemID
	  */
	  ...
	  * @param cross the maximal diameter of the plot area
	  * @return a Path representing a star in the defined space
	  */
	  ...
	  * @param centery the y position of the center
	  * @param cross the maximal diameter of the plot area
	  * @return a Path representing a pentagon in the defined space
	  */
	  ...
	  * @param centery the y position of the center
	  * @param cross the maximal diameter of the plot area
	  * @return a Path representing a diamond in the defined space
	  */

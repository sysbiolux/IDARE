...
public class ManualLayout extends AbstractLayout {
	...
	public ManualLayout(int ImageHeight, int ImageWidth, int LabelHeight ) {
...
//			PrintFDebugger.Debugging(this, comp.bundle.Label + " : " + comp.bundle + " : " + comp.area );	
	...
	{
		ManualNodeLayout layout = new ManualNodeLayout(getImageHeight(),getImageWidth(),getLabelHeight());
